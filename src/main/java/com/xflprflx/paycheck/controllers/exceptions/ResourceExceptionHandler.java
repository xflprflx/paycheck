...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(PaymentTermsUndefinedException.class)
	public ResponseEntity<StandardError> paymentTermsUndefined(PaymentTermsUndefinedException ex,
																 HttpServletRequest request) {

		StandardError error = new StandardError(System.currentTimeMillis(), HttpStatus.CONFLICT.value(),
				"Payment terms undefined.", ex.getMessage(), request.getRequestURI());
